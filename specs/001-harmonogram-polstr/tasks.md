...
- [X] T010 [P] [US2] Dodaj test rat malejących w `tests/smoke.test.ts`
...
- [X] T013 [P] [US3] Dodaj test zmiany wskaźnika w trakcie spłaty w `tests/smoke.test.ts`
- [X] T014 [P] [US3] Dodaj test ostatniej znanej wartości wskaźnika w `tests/smoke.test.ts`
...
- [X] T018 [P] [US4] Dodaj test nadpłaty w trybie `obnizRate` w `tests/smoke.test.ts`
- [X] T019 [P] [US4] Dodaj test nadpłaty w trybie `skrocOkres` w `tests/smoke.test.ts`
...
- [ ] T024 [P] [US5] Dodaj test parsowania albo walidacji parametrów API, jeśli funkcje pomocnicze trafią do czystego modułu w `tests/smoke.test.ts`
